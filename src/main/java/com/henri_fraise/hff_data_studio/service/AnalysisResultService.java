...
public class AnalysisResultService {
  ...
  @Transactional
  public AnalysisResult createResult(
  ...
  @Transactional
  public void createResultWithChart(
      AnalysisExecution execution,
      ResultType resultType,
      String title,
      String filePath,
      ...
      String configJson) {
    AnalysisResult result =
        createResult(execution, resultType, title, filePath, FileType.valueOf(fileFormat), 0);
  ...
  public List<AnalysisResultResponse> getResultsByExecution(UUID executionId) {
    List<AnalysisResult> results =
        resultRepository.findByExecutionIdOrderByDisplayOrderAsc(executionId);
