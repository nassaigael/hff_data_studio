...
public class ResourceNotFoundException extends BusinessException {
	...
	public ResourceNotFoundException(String entityName, Object id) {
		super(String.format("%s not found with id: %s", entityName, id), DEFAULT_ERROR_CODE, entityName, id);
	}
	...
	public ResourceNotFoundException(String entityName, String fieldName, Object fieldValue) {
		super(String.format("%s not found with %s: %s", entityName, fieldName, fieldValue), DEFAULT_ERROR_CODE, entityName, fieldName, fieldValue);
	}
}