...
public class DataInitializer implements CommandLineRunner {
    ...
    if (permissionRepository.count() == 0) {
      ...
      List<Permission> permissions =
          List.of(
              ...
              // Cleaning Module
              createPermission(
                  "CLEANING_RULE_CREATE", "Création de règles de nettoyage", "Cleaning"),
              createPermission(
                  "CLEANING_RULE_UPDATE", "Modification de règles de nettoyage", "Cleaning"),
              createPermission(
                  "CLEANING_RULE_DELETE", "Suppression de règles de nettoyage", "Cleaning"),
              ...
              createPermission(
                  "ANALYSIS_MODEL_SAVE", "Sauvegarde de modèles d'analyse", "Analysis"),
  ...
  private Permission createPermission(String code, String label, String module) {
    return Permission.builder().code(code).label(label).module(module).isActive(true).build();
  }
}
