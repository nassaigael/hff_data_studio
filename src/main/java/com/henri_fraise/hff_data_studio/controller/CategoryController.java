...
public class CategoryController {
  ...
  public ResponseEntity<UserCategoryResponse> updateCategory(
      @PathVariable UUID categoryId, @Valid @RequestBody CategoryCreationRequest request) {
  ...
  public ResponseEntity<Void> updateCategoryPermissions(
      @PathVariable UUID categoryId, @Valid @RequestBody PermissionUpdateRequest request) {
