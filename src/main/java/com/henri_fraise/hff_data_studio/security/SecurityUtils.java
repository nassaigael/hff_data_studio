...
public class SecurityUtils {
	...
	public static final List<String> CONSULTANT_ROLES = List.of("ADMIN", "DATA_ANALYST", "CONSULTANT");
	public static final List<String> ALL_ROLES = List.of("ADMIN", "DATA_ANALYST", "CONSULTANT", "INVITE");
